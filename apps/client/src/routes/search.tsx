...
export const Route = createFileRoute('/search')({
  ...
  loader: async ({ context, deps }) => {
    ...
    return {
      products: await context.queryClient.ensureQueryData(productsQueryOptions(deps)),
      collections: await context.queryClient.ensureQueryData(collectionsQueryOptions()),
    };
  },
  pendingMinMs: 0,
});
